...
const INPUT_GROUP_BASE =
  "group/input-group border-input relative flex w-full items-center rounded-md border " +
...
export type InputGroupAddonAlign = keyof typeof inputGroupAddonAligns;
...
const INPUT_GROUP_BUTTON_BASE = "text-sm shadow-none flex gap-2 items-center";
...
export type InputGroupButtonSize = keyof typeof inputGroupButtonSizes;
