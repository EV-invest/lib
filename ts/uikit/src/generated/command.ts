...
export const COMMAND_ROOT = "bg-popover text-ink flex h-full w-full flex-col overflow-hidden rounded-md";
...
export const COMMAND_SHORTCUT = "text-ink-soft ml-auto text-xs tracking-widest";
