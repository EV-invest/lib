 ...
 *
 * It hands the page nothing but the path it rewrites to. A page that read a
 * request header would render per request, and every page here is cached
 * (ISR); the link mode rides in the route param instead (`/fr/_royat`).
 *
...
import { createRouting, LANG_COOKIE, LANG_COOKIE_MAX_AGE } from "../core/routing";
...
export { LANG_COOKIE, LANG_COOKIE_MAX_AGE } from "../core/routing";
