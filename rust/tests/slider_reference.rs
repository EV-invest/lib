...
// <span data-slot="slider" data-orientation="horizontal" class="...[&amp;_[data-slot=slider-track]]:bg-background/50..." aria-label="Principal investment">
...
const EXPECTED: &str = concat!(
	r#"<span class="relative flex w-full touch-none items-center select-none data-[disabled]:opacity-50 data-[orientation=vertical]:h-full data-[orientation=vertical]:min-h-44 data-[orientation=vertical]:w-auto data-[orientation=vertical]:flex-col [&#38;_[data-slot=slider-track]]:bg-background/50 [&#38;_[data-slot=slider-range]]:bg-accent-debug [&#38;_[data-slot=slider-thumb]]:border-accent-debug" data-slot="slider" data-orientation="horizontal" aria-label="Principal investment">"#,
	...
	fn app() -> Element {
		rsx! {
			Slider {
				...
				class: "[&_[data-slot=slider-track]]:bg-background/50 [&_[data-slot=slider-range]]:bg-accent-debug [&_[data-slot=slider-thumb]]:border-accent-debug",
			}
		}
	}
