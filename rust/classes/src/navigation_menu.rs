...
pub const NAVIGATION_MENU_LINK: &str = "data-[active=true]:focus:bg-accent data-[active=true]:hover:bg-accent data-[active=true]:bg-accent/50 \
...
pub const NAVIGATION_MENU_VIEWPORT: &str = "origin-top-center bg-popover text-popover-foreground data-[state=open]:animate-in \
