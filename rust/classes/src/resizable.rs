pub const RESIZABLE_GROUP: &str = "flex h-full w-full data-[panel-group-direction=vertical]:flex-col";
pub const RESIZABLE_PANEL: &str = "relative";
pub const RESIZABLE_HANDLE: &str = "bg-border focus-visible:ring-ring relative flex w-px items-center justify-center after:absolute \
