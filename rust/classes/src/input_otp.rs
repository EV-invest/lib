...
pub const INPUT_OTP_SLOT: &str = "data-[active=true]:border-ring data-[active=true]:ring-ring/50 data-[active=true]:aria-invalid:ring-accent-error/20 \
	 aria-invalid:border-accent-error data-[active=true]:aria-invalid:border-accent-error border-input relative flex h-9 \
...
pub const INPUT_OTP_SLOT_CARET: &str = "animate-caret-blink bg-ink h-4 w-px duration-1000";
