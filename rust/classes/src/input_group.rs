...
pub const INPUT_GROUP_BASE: &str = "group/input-group border-input relative flex w-full items-center rounded-md border \
                                    ...
                                    has-[[data-slot][aria-invalid=true]]:ring-accent-error/20 has-[[data-slot][aria-invalid=true]]:border-accent-error";

pub const INPUT_GROUP_ADDON_BASE: &str = "text-ink-soft flex h-auto cursor-text items-center justify-center gap-2 \
...
pub const INPUT_GROUP_TEXT: &str = "text-ink-soft flex items-center gap-2 text-sm [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4";
