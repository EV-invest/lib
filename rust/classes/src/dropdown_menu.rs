use crate::focus::option_focus_ring;
...
pub const DROPDOWN_MENU_ITEM: &str = concat!(
...
pub const DROPDOWN_MENU_CHECK_ITEM: &str = concat!(
	"focus:bg-hover focus:text-ink ",
	option_focus_ring!(),
...
pub const DROPDOWN_MENU_SUB_TRIGGER: &str = concat!(
	"focus:bg-hover focus:text-ink ",
	option_focus_ring!(),
